	...
	<div id="flipkart-navbar">
		<div class="container">
			<div class="row row1">
				<ul class="largenav pull-right">
					...
					<li class="upper-links dropdown"><a class="links"
						href="http://clashhacks.in/">${user.username}</a>
			...
			<div class="row row2">
				<div class="col-sm-2">
					<h2 style="margin: 0px;">
						<span class="smallnav menu" onclick="openNav()">SitoBello</span>
					</h2>
					<h1 style="margin: 0px;">
						<a href="" class="largenav">SitoBello</a>
					</h1>
				</div>
				...
				<div class="cart largenav col-sm-2">
					<a class="cart-button" href="cart"> <svg class="cart-svg " width="16 "
                        ...
                        <path
								...
								fill="#fff "></path>
                    </svg> Cart <span class="item-number ">${user.carrello.size() }</span>
					</a>
				</div>
			</div>
		</div>
		...
		<div class="row pt-1">
			<div class="col-md-4 col-md-offset-4">
				<article class="col-item">
					<div class="photo">
						<a href="#"> <img src="https://unsplash.it/500/300?image=0"
					...
					<div class="info">
						<div class="row">
							<div class="price-details col-md-6">
								<p class="details">${product.description }
								</p>
								<h1>${product.title }</h1>
						...
						<div class="separator clear-left">
							<p class="btn-add">
								<i class="fa fa-shopping-cart"></i><a href="cart?id=${product.id }" class="hidden-sm">Add
									to cart</a>
							</p>
						</div>
